...
const deployImplementationAndFactory = async () => {
  ...
  //   Bootstrap__factory.abi,
  //   Bootstrap__factory.bytecode,
  //   wallet,
  // );
...
const main = async () => {
  ...
  const ownerAddress = wallet.address;
  console.log(`owmer address: ${ownerAddress}`);
  const nexusAddress = "0x662240cA7799464e8223EcBDC2963D7bDb76c912";
  const nexusFactoryAddress = "0x68B3d54D20Ee83Da761a6dF03166520E91daf14c";
  const bootStrapLibAddress = "0x5617469Da63fB66CFFf8000FA4b9F97e9706b0c8";
  const bootStrapAddress = "0x609Ff2ab292137acd94713DD97EB74A509741575";
  ...
  const bootStrap = Bootstrap__factory.connect(bootStrapAddress, wallet);
  ...
  const initData =
    await bootStrap.getInitNexusWithSingleValidatorCalldata(parsedValidator1);
