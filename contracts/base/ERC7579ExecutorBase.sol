...
import { IExecutor as IERC7579Executor } from "../interfaces/modules/IExecutor.sol";
import { IERC7579Account } from "../interfaces/IERC7579Account.sol";
import { Execution, ExecLib as ERC7579ExecutionLib } from "../lib/ExecLib.sol";
import { ModeCode, ModeLib as ERC7579ModeLib, CALLTYPE_SINGLE, EXECTYPE_DEFAULT, MODE_DEFAULT, ModePayload, CALLTYPE_BATCH, EXECTYPE_DEFAULT, MODE_DEFAULT, CALLTYPE_DELEGATECALL } from "../lib/ModeLib.sol";
...
abstract contract ERC7579ExecutorBase is IERC7579Executor, ERC7579ModuleBase {
    ...
    function _executeDelegateCall(address account, address delegateTarget, bytes memory callData) internal returns (bytes[] memory results) {
        ModeCode modeCode = ERC7579ModeLib.encode({
    ...
    // Note: Not every account will support delegatecalls
    function _executeDelegateCall(address delegateTarget, bytes memory callData) internal returns (bytes[] memory results) {
