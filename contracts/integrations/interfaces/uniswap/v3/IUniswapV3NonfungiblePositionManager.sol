...
abstract contract IUniswapV3NonfungiblePositionManager {
    ...
    function mint(MintParams calldata params) external payable virtual returns (uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1);
    ...
    function decreaseLiquidity(DecreaseLiquidityParams calldata params) external payable virtual returns (uint256 amount0, uint256 amount1);
